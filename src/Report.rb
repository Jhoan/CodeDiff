module Report	
	def self.make_report(programs)
		raise ArgumentException, "Expected Array but got #{programs.class.name} instead." unless programs.is_a? Array
		all_vars = Array.new()
